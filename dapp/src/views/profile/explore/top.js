...
import { getalltopprice, getTopAllCollection } from "../../../redux/actions/main"
...
class Top extends React.Component {
    ...
    gotoCollectionDetails = (key) => {
        if (this.state.data && this.state.data.collection.length > 0) {
            this.props.navigate("/collection/" + this.state.data?.collection[key]?._id)
        }
    }
                                                    ...
                                                    <Typography variant="h2" sx={{ color: "#707a83 !important", fontWeight: "600 !important" }}>{index + 1}</Typography>
                                                            ...
                                                            <Box className={this.props.classes.namebox}>
                                                                <span className={this.props.classes.spanbox}>
                                                                    <Box className={this.props.classes.imgbox} component="img" src={row.coverUrl}>
                                                                    </Box>
                                                                </span>
                                                            </Box>
                                                            <Box sx={{ display: "flex" }}>
                                                                <Typography className={this.props.classes.name}>{row.name}</Typography>&nbsp;&nbsp;
                                                        ...
                                                        <TableCell align="center" className={this.props.classes.ether}>
                                                            <Box sx={{ display: "flex", justifyContent: "right", alignItems: "center" }}>
                                                                <Box className={this.props.classes.namebox} sx={{ height: "100%", width: "30px", backgroundColor: "unset !important", border: "none" }}>
                                                                    {
                                                                        row?.blockchain === "cardano" ? <Box component="img" className={this.props.tclasses.imgbox} src={cardano.src}></Box> : row?.blockchain === "ethereum" ? <Box component="img" className={this.props.tclasses.imgbox} src={ether.src}></Box> : row?.blockchain === "binance" ? <Box component="img" className={this.props.tclasses.imgbox} src={binance.src}></Box> : row?.blockchain === "polygon" ? <Box component="img" className={this.props.tclasses.imgbox} src={polygon.src}></Box> : row?.blockchain === "solana" ? <Box component="img" className={this.props.tclasses.imgbox} src={solana.src}></Box> : ""
                                                                    }
                                                                </Box>
                                                                    ...
                                                                    row.floor !== 0 ?
                                                                        <Stack direction="row" alignItems="center" justifyContent="right">
                                                                            <Box className={this.props.classes.namebox} sx={{ height: "30px", width: "30px", backgroundColor: "unset !important", border: "none" }}>
                                                                                {
                                                                                    row?.blockchain === "cardano" ? <Box component="img" className={this.props.tclasses.imgbox} sx={{ width: "100%" }} src={cardano.src}></Box> : row?.blockchain === "ethereum" ? <Box component="img" className={this.props.tclasses.imgbox} sx={{ width: "100%" }} src={ether.src}></Box> : row?.blockchain === "binance" ? <Box component="img" className={this.props.tclasses.imgbox} sx={{ width: "100%" }} src={binance.src}></Box> : row?.blockchain === "polygon" ? <Box component="img" className={this.props.tclasses.imgbox} sx={{ width: "100%" }} src={polygon.src}></Box> : row?.blockchain === "solana" ? <Box component="img" className={this.props.tclasses.imgbox} sx={{ width: "100%" }} src={solana.src}></Box> : ""
                                                                                }
                                                                            </Box>
                                                                            <Typography className={this.props.classes.volletter}>&nbsp;&nbsp;{convertFormatedDigit((row?.floor || 0), 2, row?.blockchain)}</Typography>
                                                                        </Stack>
                                                                        : <RemoveIcon></RemoveIcon>
                                                                }
                                                            </Box>
...
const TopWrap = (props) => {
    ...
    const getData = async (toppage, size = 100, category, blockchain, name) => {
        const result = await getTopAllCollection({
            toppage,
            size: size,
            query: {
                categories: category,
    ...
    return <Top {...props} navigate={navigate} tclasses={tclasses} classes={classes} getData={getData} fetchdata={fetchdata} />;
}
