...
import { axiosServices, axiosInstance, getHeaders } from "/src/services";
import { setLocalStorageItem, getLocalStorageItem } from "/src/utils/utility";

import * as types from "../../types/walletTypes";

export const setWalletData = (params) => {
...
export function setWalletData2(payload) {
  return {
